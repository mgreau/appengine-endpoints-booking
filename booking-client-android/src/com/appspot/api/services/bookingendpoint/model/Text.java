...
public final class Text extends GenericJson {
   ...
   * example, a request that returns a single {@link Text} would include the response headers, while
   * a request which returns an array of {@link Text}, would have a non-null response header in the
