...
/**
 * Model definition for CollectionResponseHotel.
 *
 ...
 * @author Google, Inc.
 */
public final class CollectionResponseHotel extends GenericJson {
   ...
   */
  public CollectionResponseHotel setNextPageToken(String nextPageToken) {
   ...
   * The value set may be {@code null}.
   */
  public CollectionResponseHotel setItems(java.util.List<Hotel> items) {
    this.items = items;
    return this;
  }
   ...
   * example, a request that returns a single {@link CollectionResponseHotel} would include the
   * response headers, while a request which returns an array of {@link CollectionResponseHotel},
